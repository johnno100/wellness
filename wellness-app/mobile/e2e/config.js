...
module.exports = {
  ...
  apps: {
    ...
    'ios.release': {
      type: 'ios.app',
      binaryPath: 'ios/build/Build/Products/Release-iphonesimulator/WellnessApp.app',
      build: 'xcodebuild -workspace ios/WellnessApp.xcworkspace -scheme WellnessApp -configuration Release -sdk iphonesimulator -derivedDataPath ios/build'
    },
    'android.debug': {
      type: 'android.apk',
