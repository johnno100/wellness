/**
 * Neo4j TestContainer setup for integration tests
 ...
 * @returns {Promise<{container: Neo4jContainer, driver: Driver, session: Session, uri: string, username: string, password: string}>}
 */
async function setupNeo4jContainer() {
  ...
  return { container, driver, session, uri, username, password };
}
